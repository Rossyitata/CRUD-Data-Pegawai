...
<body>
    ...
    <form action="proses_ubah.php" method="post">
        ...
        nama pegawai:
        <input type="varchar" name="nama" value="<?= $dt_pegawai['nama'] ?>" class="form-control">
        Alamat :
        ...
        <select name="jenis_kelamin" class="form-control">
            ...
            <?php endforeach ?>
        Nomor Telepon :
        <input type="varchar" name="no_tlp" value="<?= $dt_pegawai['no_tlp'] ?>" class="form-control">
        </select>
        Jabatan :
        <select name="id_jabatan" class="form-control">
            <option>
                ...
                while ($data_jabatan = mysqli_fetch_array($qry_jabatan)) {
                    if ($data_jabatan['id_jabatan'] == $dt_pegawai['jabatan']) {
                        $selek = "selected";
                    } else {
                        $selek = "";
                    }
